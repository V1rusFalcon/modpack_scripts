...
--   Run this program first, then run build_platform.lua on each turtle.
--   All turtles must start at the SAME bottom-left corner of the full platform
--   area, ONE BLOCK ABOVE ground, facing along the LENGTH direction.
...
print(string.format(
    "\nJob: %d x %d x %d (%d stone + %d dirt), %d turtle(s).",
    WIDTH, LENGTH, STONE_LAYERS + DIRT_LAYERS, STONE_LAYERS, DIRT_LAYERS, NUM_TURTLES))
